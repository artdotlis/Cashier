...
def _p_it_cr(
    item_i: int, price: Decimal, cnt: int, imp: bool, tax: bool
) -> PurchasedItem:
    return PurchasedItem(
        imported=imp, name=f"item_{item_i}", price=price, cnt=cnt, taxed=tax
    )
